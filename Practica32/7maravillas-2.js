let maravillas = ["chichen-itza.svg", "coliseo.svg", "cristo-redentor.svg", 
"machu-picchu.svg", "muralla-china.svg","petra.svg","taj-mahal.svg"];
...
function cargarMaravilla(){
    if(maravillas.length <= posActual){
        ...
        document.getElementById("imgMaravilla").src = "/imagen/" + maravillas[posActual];
